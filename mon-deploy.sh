...
rm -rf /var/lib/ceph/mon/ceph-$MONHOSTNAME
...
mkdir -p /var/lib/ceph/mon/ceph-$MONHOSTNAME
...
monmaptool --create --add $MONHOSTNAME 172.31.4.82 --fsid 1e174f1e-8559-11eb-8520-d15a5aa7f296 /tmp/monmap
